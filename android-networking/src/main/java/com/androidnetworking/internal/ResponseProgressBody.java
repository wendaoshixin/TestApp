...
public class ResponseProgressBody extends ResponseBody {
    ...
    /*liuzhi 断点续传添加 20180815*/
    private long startFrom = 0;

    public ResponseProgressBody(ResponseBody responseBody, DownloadProgressListener downloadProgressListener, long startFrom) {
                ...
                if (downloadProgressHandler != null) {
                    downloadProgressHandler
                            .obtainMessage(ANConstants.UPDATE,
                                    new Progress(totalBytesRead + startFrom, mResponseBody.contentLength()))
                            .sendToTarget();
                }
                return bytesRead;
            }
